    ...
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $sql_detail_actor="select title, A.movie_id,A.character
 from Actor A, Movie M
where A.movie_id = M.movie_id and A.name= '$keyWord'";

                if (!empty($keyWord)){
                    echo"<h1>Actor: $keyWord</h1>";
                    echo "<table >
         <tr>
         <th>Title</th>
         <th>Character</th>
                    ...
                    $actor_detail = mysqli_query($conn ,$sql_detail_actor) or die("can not search");
                    while($row = mysqli_fetch_array($actor_detail)){
                        echo "<tr>";
                        $movie_id = $row['movie_id'];
                        $movie_title = $row['title'];
                        $character = $row['character'];
                        echo "<td>" . "<a href='movie_detail_search.php?m=$movie_id'>$movie_title<br></a> " . "</td>";
