    ...
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $sql_detail_job="select title, A.movie_id,A.name
 from Crew A, Movie M
where A.movie_id = M.movie_id and A.job = '$keyWord'";

                if (!empty($keyWord)){
                    echo"<h1>Job: $keyWord</h1>";
                    echo "<table >
         <tr>
         <th>Title</th>
         <th>Actor_name</th>
                    ...
                    $character_detail = mysqli_query($conn ,$sql_detail_job) or die("can not search");
                    while($row = mysqli_fetch_array($character_detail)){
                        ...
                        $crew_1 = $row['name'];
                        echo "<td>" . "<a href='crew_detail_search.php?c=$crew_1'>$crew_1<br></a>". "</td>";
                        echo "</tr>";}
                    echo "</table>";
                    echo "<br>";}
                ?>
