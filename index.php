...
<div class="full">
    <div class="menu">
        <ul>
            <li><a class="active" href="index.php"><div class="hm"><i class="home1"></i><i class="home2"></i></div></a></li>
                ...
                <main class="container">
                    ...
                    <form role="form" action="results.php" method="post">
                        <div class="form-group">
                            <label for="return-type">Select a </label>
                            <select name="return-type" class="form-control" id="return-type">
                                <option>Actor</option>
                                <option>Crew</option> <!-- Director -->
                                <option>Movie</option>
                            </select>
                        </div>
                        ...
                        <!--
                                <div class="form-group">
                                  <label for="exampleFormControlSelect1">arrange by</label>
                                  <select class="form-control" id="sort_by">
                                    <option></option>
                                    <option>title</option>
                                    <option>budget</option>
                                    <option>release_data</option>
