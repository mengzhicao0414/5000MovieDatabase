...
<div class="full">
    <div class="menu">
        <ul>
            ...
            <li><a class="active"  class = 'info'href="critiques.php">Reception</classa></li>
        </ul>
    </div>
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $Query = "SELECT " . return_attributes("Reception") . " FROM Reception, Movie WHERE Reception.movie_id=Movie.movie_id";
                display_query($Query, "Reception");
                ?>
