    ...
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $sql_detail_crew="select title, C.movie_id, C.job
 from Crew C, Movie M
where C.movie_id = M.movie_id and C.name= '$keyWord'";

                if (!empty($keyWord)){
                    echo"<h1>Crew: $keyWord</h1>";
                    echo "<table >
         <tr>
         <th>Title</th>
         <th>Job</th>
                    ...
                    $crew_detail = mysqli_query($conn ,$sql_detail_crew) or die("can not search");
                    while($row = mysqli_fetch_array($crew_detail)){
                        echo "<tr>";
