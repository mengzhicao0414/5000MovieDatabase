...
<div class="full">
    <div class="menu">
        <ul>
            ...
            <li><a class="active" class = 'info'href="directors.php">Crew</classa></li>
    ...
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $Query = "SELECT " . return_attributes("Crew") . " FROM Crew";
                #$Query = "SELECT " . return_attributes("Directors") . " FROM Crew";
                display_query($Query, "Crew");
                ?>
