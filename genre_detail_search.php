    ...
    <div class="main">
        <div class="review-content">
            ...
            <div class="reviews-section">
                ...
                $sql_detail_genre="select M.title,G.movie_id
 from Genre G, Movie M
where G.genre = '$keyWord'and G.movie_id = M.movie_id ";

                if (!empty($keyWord)){
                    echo"<h1>Genre: $keyWord</h1>";
                    echo "<table>
         <tr>
         <th>Title</th>
         </tr>";

                    $title = mysqli_query($conn ,$sql_detail_genre) or die("can not search");
